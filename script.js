...
// пофиксить когда при нажатие на равно у нас все стирается -- fixed (maybe)

// пофиксить когда несколько раз жмакая на равно выводится ммного значений


// пофиксить когда в конце мы получили ответ, чтобы с не сстерела все
